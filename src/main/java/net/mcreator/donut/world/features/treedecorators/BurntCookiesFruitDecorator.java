package net.mcreator.donut.world.features.treedecorators;
...
public class BurntCookiesFruitDecorator extends CocoaDecorator {
	public static final BurntCookiesFruitDecorator INSTANCE = new BurntCookiesFruitDecorator();
	public static com.mojang.serialization.Codec<BurntCookiesFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("burnt_cookies_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BurntCookiesFruitDecorator() {
		super(0.2f);
	}
