...
public class BurntCookiesLeaveDecorator extends LeaveVineDecorator {
	public static final BurntCookiesLeaveDecorator INSTANCE = new BurntCookiesLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("burnt_cookies_tree_leave_decorator");
